  ...
  capabilities: {
    tools: [
      // ======== 画图 ========
      {
        ...
        commandMapping: {
          kind: 'template',
          template: "snow draw --prompt {{prompt}} --style {{style}} --size {{size}} --out {{outFile}} --seed {{seed}}",
      ...
      // ======== 翻译 ========
      {
        ...
        commandMapping: {
          kind: 'template',
          template: "snow translate --text {{text}} --from {{sourceLang}} --to {{targetLang}} --domain {{domain}} --format json",
        },
      ...
      // ======== 文生语音 ========
      {
        ...
        commandMapping: {
          kind: 'template',
          template: "snow tts --text {{text}} --voice {{voice}} --speed {{speed}} --out {{outFile}}",
          outputFileVar: 'outFile',
        },
        outputParser: {
          kind: 'custom',
      ...
      // ======== 语音转写 ========
      {
        ...
        commandMapping: {
          kind: 'template',
          template: "snow asr --in {{inFile}} --lang {{lang}} --timestamp {{withTimestamp}} --speaker {{withSpeaker}} --format json",
        },
        outputParser: 'stdout-json',
        timeoutMs: 300_000,
        estimatedCredits: 5,
